...
class AlamofireLoader {
    ...
    func loadWeather(completion: @escaping (DailyDate) -> Void) {
        AF.request("https://api.openweathermap.org/data/2.5/onecall?lat=55.7522200&lon=37.6155600&daily=7&appid=c54f405569613556a8b049e8058b8be2&lang=ru&units=metric").responseJSON { response in
